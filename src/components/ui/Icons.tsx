...
export const AlertTriangleIcon: React.FC<IconProps> = ({ className = '', size = 24, style }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const MapPinIcon: React.FC<IconProps> = ({ className = '', size = 24, style }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ChevronLeftIcon: React.FC<IconProps> = ({ className = '', size = 24, style }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ChevronRightIcon: React.FC<IconProps> = ({ className = '', size = 24, style }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const BookmarkIcon: React.FC<IconProps> = ({ className = '', size = 24, style }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const FolderIcon: React.FC<IconProps> = ({ className = '', size = 24, style }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
